...
export const themeConfig = {
  ...
  siteMeta: {
    ...
    // 站点地址
    site: "https://guangzhou.suporka.site",
    // 语言
    lang: "zh-CN",
    // 作者
    author: {
    ...
    header: [
      ...
      [
        "link",
        {
          ...
          title: "RSS",
          href: "https://guangzhou.suporka.site/rss.xml",
        },
      ],
      // 预载 CDN
      [
  ...
  comment: {
    ...
    twikoo: {
      ...
      envId: "https://twikoo-netlify-suporka.netlify.app/.netlify/functions/twikoo",
  ...
  aside: {
    ...
    hello: {
      enable: true,
      text: "广州、美食、探店、城市观察、热点评论、广州生活、年轻人生活方式。",
    },
    // 目录
    toc: {
      enable: true,
